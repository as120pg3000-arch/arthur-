...
# ========== الاعدادات ==========
TOKEN = "8915930254:AAHXYtgC16geY8lbCmf6b8EJBxYBawCMp_8"
ADMIN_ID = [8554791859, 8203735647]
        ...
        if ':' in line:
            ...
            if email and pwd:
                if email in current_emails:
                    ...
                    added += 1
                current_emails[email] = pwd  # تحديث أو إضافة
...
def start_sending_process(call):
    ...
    # تحميل إيميلات الشد من الملف النصي
    sender_dict = load_sender_emails(user_id)
    ...
    # تحويل القاموس إلى قائمة (بريد, كلمة مرور)
